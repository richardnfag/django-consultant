...
class TestAvailableFieldsView:
    ...
    def test_get_available_fields(self, client, loan_field):
        ...
        expected_fields = [
            ...
            {'name': 'valor_da_proposta', 'label': 'Valor da Proposta', 'data_type': 'number'}
        ]
...
class TestSubmitProposalView:
    ...
    def test_submit_proposal(self, client, loan_field):
        ...
        response = client.post('/submit-proposal/', data=data, content_type='application/json')
    ...
    def test_submit_proposal_with_invalid_data(self, client, loan_field):
        ...
        response = client.post('/submit-proposal/', data=invalid_data, content_type='application/json')
